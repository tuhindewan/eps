            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-content d-flex flex-column align-items-center text-center">
                        <h3>Enhancing Banking Services</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-12 col-md-6 order-2 order-md-1">
                        ...
                        <div class="maintenance-content my-5 my-md-0">
                            <h2>{{ $enhancing->title }}</h2>
                            <p>
                                {!! $enhancing->description !!}
                                {{-- @if (strlen($enhancing->description) > 200)
                                    <span id="dots">......</span>
                                    <span id="more">{!! substr($enhancing->description, 200) !!}</span>
                                @endif
                    ...
                    <div class="col-12 col-sm-10 col-md-6 order-1 order-md-2 mx-auto pt-4 pt-md-0">
                        <img src="{{ 'images/'.$enhancing->image }}" alt="">
                    </div>
                </div>
            </div>
        </div>
